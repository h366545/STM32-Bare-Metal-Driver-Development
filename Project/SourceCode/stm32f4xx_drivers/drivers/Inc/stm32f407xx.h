...
#define SRAM 						SRAM1_BASEADDR		/*SRAM1 as the main SRAM*/
...
#define APB1PERIPH_BASEADDR			PERIPH_BASEADDR		/*Base address of APB1 bus domain*/
#define APB2PERIPH_BASEADDR			0x40010000U			/*Base address of APB2 bus domain*/
#define AHB1PERIPH_BASEADDR			0x40020000U			/*Base address of AHB1 bus domain*/
#define AHB2PERIPH_BASEADDR			0x50000000U			/*Base address of AHB2 bus domain*/
...
#define EXTI_BASEADDR				(APB2PERIPH_BASEADDR + 0x3C00)			/*Base address of external interrupt controller*/
#define SPI1_BASEADDR				(APB2PERIPH_BASEADDR + 0x3000)			/*Base address of SPI1*/
#define SYSCFG_BASEADDR				(APB2PERIPH_BASEADDR + 0x3800)			/*Base address of system configuration*/
...
typedef struct
{
	...
	__vo uint32_t AHB3RSTR;		/*RCC AHB3 peripheral reset register								Address offset: 0x18*/
		 uint32_t RESERVED0;	/*Reserved register 												Address offset: 0x1C*/
	__vo uint32_t APB1RSTR;		/*RCC APB1 peripheral reset register								Address offset: 0x20*/
	__vo uint32_t APB2RSTR;		/*RCC APB2 peripheral reset register								Address offset: 0x24*/
		 uint32_t RESERVED1[2];	/*Reserved registers 												Address offset: 0x28-0x2C*/
	__vo uint32_t AHB1ENR;		/*RCC AHB1 peripheral clock enable register							Address offset: 0x30*/
	__vo uint32_t AHB2ENR;		/*RCC AHB2 peripheral clock enable register							Address offset: 0x34*/
	__vo uint32_t AHB3ENR;		/*RCC AHB3 peripheral clock enable register							Address offset: 0x38*/
		 uint32_t RESERVED2;	/*Reserved register 												Address offset: 0x3C*/
	__vo uint32_t APB1ENR;		/*RCC APB1 peripheral clock enable register							Address offset: 0x40*/
	__vo uint32_t APB2ENR;		/*RCC APB2 peripheral clock enable register							Address offset: 0x44*/
		 uint32_t RESERVED3[2];	/*Reserved registers 												Address offset: 0x48-0x4C*/
	__vo uint32_t AHB1LPENR;	/*RCC AHB1 peripheral clock enable in low power mode register		Address offset: 0x50*/
	__vo uint32_t AHB2LPENR;	/*RCC AHB2 peripheral clock enable in low power mode register		Address offset: 0x54*/
	__vo uint32_t AHB3LPENR;	/*RCC AHB3 peripheral clock enable in low power mode register		Address offset: 0x58*/
		 uint32_t RESERVED4;	/*Reserved register 												Address offset: 0x5C*/
	...
	__vo uint32_t APB2LPENR;	/*RCC APB2 peripheral clock enable in low power mode register		Address offset: 0x64*/
		 uint32_t RESERVED5[2];	/*Reserved registers 												Address offset: 0x68-0x6C*/
	__vo uint32_t BDCR;			/*RCC Backup domain control register								Address offset: 0x70*/
	__vo uint32_t CSR;			/*RCC clock control & status register								Address offset: 0x74*/
	 	 uint32_t RESERVED6[2];	/*Reserved registers 												Address offset: 0x78-0x7C*/
...
typedef struct
{
	...
	__vo uint32_t SYSCFG_EXTICR[4];	/*SYSCFG external interrupt configuration register 1-4	Address offset: 0x08 - 0x14*/
		 uint32_t RESERVED[2];		/*Reserved registers									Address offset: 0x18 - 0x1C*/
...
#define GPIOA		((GPIO_RegDef_t*)GPIOA_BASEADDR)		/*Type cast the base address of the peripheral to the structure pointer type*/
...
#define I2C1_REG_RESET()		do{(RCC->APB1RSTR |= (1 << 21)); (RCC->APB1RSTR &= ~(1 << 14));}while(0)
#define I2C2_REG_RESET()		do{(RCC->APB1RSTR |= (1 << 22)); (RCC->APB1RSTR &= ~(1 << 15));}while(0)
#define I2C3_REG_RESET()		do{(RCC->APB1RSTR |= (1 << 23)); (RCC->APB1RSTR &= ~(1 << 15));}while(0)
...
#define USART1_REG_RESET()		do{(RCC->APB2RSTR |= (1 << 17)); (RCC->APB2RSTR &= ~(1 << 4));}while(0)
#define USART2_REG_RESET()		do{(RCC->APB1RSTR |= (1 << 17)); (RCC->APB1RSTR &= ~(1 << 14));}while(0)
#define USART3_REG_RESET()		do{(RCC->APB1RSTR |= (1 << 18)); (RCC->APB1RSTR &= ~(1 << 15));}while(0)
#define UART4_REG_RESET()		do{(RCC->APB1RSTR |= (1 << 19)); (RCC->APB1RSTR &= ~(1 << 15));}while(0)
#define UART5_REG_RESET()		do{(RCC->APB1RSTR |= (1 << 20)); (RCC->APB1RSTR &= ~(1 << 15));}while(0)
#define USART6_REG_RESET()		do{(RCC->APB2RSTR |= (1 << 17)); (RCC->APB2RSTR &= ~(1 << 5));}while(0)
...
/*
 * Returns port code (between 0 - 7) for given GPIOx base address
 */
 ...
 * Note: Update theses macros with valid values according to your MCU
 */
